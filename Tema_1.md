...
```
### Результат.
![Меню](https://github.com/VernalisVentus/SoftwareEngineering/blob/theme_1/pictures/%D0%A0%D0%B8%D1%81%D1%83%D0%BD%D0%BE%D0%BA1.png)
...
## Выводы
--amend открывает редактор (в моем случае VSCode). Можно исправить параметры коммита. git rebase -i HEAD~3 исправить коммит два коммита назад
...
Гит - наиболее популярный инструмент управления версиями. Он позволяет работать совместно, в оффлайне, восстанавливать данные, эффективно управлять конфликтами и тп.
